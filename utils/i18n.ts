...
const hi: Translations = {
  ...
  dashboard: { 
    ...
    totalAssetsNT: 'कुल संपत्ति (NT$)',
    marketValueNT: 'बाजार मूल्य (NT$)',
    balanceNT: 'शेष (NT$)',
    profitNT: 'लाभ (NT$)',
