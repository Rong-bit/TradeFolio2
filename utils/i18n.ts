...
const ko: Translations = {
  ...
  accounts: { addAccount: '계좌 추가', accountName: '계좌명', accountNamePlaceholder: '예: 富邦證券, Firstrade', currency: '통화', currencyTWD: '대만 달러', currencyUSD: '미국 달러', currencyJPY: '일본 엔', currencyEUR: '유로', currencyGBP: '영국 파운드', currencyHKD: '홍콩 달러', currencyKRW: '한국 원', currencyCNY: '중국 위안', currencyINR: '인도 루피', currencyCAD: '캐나다 달러', subBrokerage: '해외 증권', add: '추가', update: '업데이트', editAccount: '편집', balance: '잔액', cancel: '취소', updateAccount: '업데이트', confirmDelete: '삭제 확인', confirmDeleteMessage: '「{name}」을(를) 삭제하시겠습니까?', deleteWarning: '거래 기록은 삭제되지 않지만 필터에 문제가 생길 수 있습니다.', deleteAccount: '삭제', noAccounts: '계좌가 없습니다.', cashBalance: '현금 잔액', editAccountTitle: '계좌 편집' },
...
zhCN.accounts = { ...zhTW.accounts, currencyTWD: '台币', currencyUSD: '美元', currencyJPY: '日元', currencyEUR: '欧元', currencyGBP: '英镑', currencyHKD: '港币', currencyKRW: '韩元', currencyCNY: '人民币', currencyINR: '印度卢比', currencyCAD: '加元', subBrokerage: '海外券商' };
